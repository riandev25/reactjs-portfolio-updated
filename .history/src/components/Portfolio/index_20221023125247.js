...
const Portfolio = () => {
  // const {lettersArray, techArray, featuresArray, demolink, codeLink, portfolioImage} = schoolPortfolio
  const school = usePortfolio(schoolPortfolio)
  const weather = usePortfolio(weatherPortfolio)
