...
const SkillList = () => {
  ...
  const iconSize = useWindowSize(768)
  return (
      ...
      <section classname="flex flex-col gap-4">
        ...
        <span className="flex flex-row gap-4 justify-center items-center">
          <FigWrapper caption="HTML5">
            <FontAwesomeIcon icon={faHtml5} color="#F06529" size={iconSize} />
          </FigWrapper>
          <FigWrapper caption="CSS3">
            <FontAwesomeIcon icon={faCss3} color="#28A4D9" size={iconSize} />
          </FigWrapper>
          ...
          <FigWrapper caption="NodeJS">
            <img className="w-24 md:w-32" src={NodejsIcon} alt="nodejs" />
          </FigWrapper>
        </span>
      </section>
      <section classname="flex flex-col justify-center items-center gap-4 ">
        ...
        <span className="flex flex-row gap-4">
          <FigWrapper caption="ReactJS">
            <FontAwesomeIcon icon={faReact} color="#5ED4F4" size={iconSize} />
          </FigWrapper>

          <FigWrapper caption="TailwindCSS">
            <img className="w-24 md:w-32" src={TailwindIcon} alt="tailwind" />
          </FigWrapper>
          <FigWrapper caption="NextJS">
            <img className="w-24 md:w-32" src={NextjsIcon} alt="nextjs" />
          </FigWrapper>
        </span>
      </section>
      <section classname="flex flex-col gap-4">
        ...
        <span className="flex flex-row gap-4">
          <FigWrapper caption="MongoDB">
            <img className="w-24 md:w-32" src={MongodbIcon} alt="mongodb" />
          </FigWrapper>

          <FigWrapper caption="Redux">
            <img className="w-24 md:w-32" src={ReduxIcon} alt="redux" />
          </FigWrapper>
      ...
      <section classname="flex flex-col gap-4">
        ...
        <span className="flex flex-row gap-4">
          <FigWrapper caption="ExpressJS">
            <img className="w-24 md:w-32" src={ExpressjsIcon} alt="expressjs" />
          </FigWrapper>

          <FigWrapper caption="MySql">
            <img className="w-24 md:w-32" src={MysqlIcon} alt="mysql" />
          </FigWrapper>
        </span>
      </section>
    </div>
