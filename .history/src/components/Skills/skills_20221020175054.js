    ...
    <div>
      <section>
        ...
        <section className="flex">
          ...
          <img className="w-32 flex" src={TailwindIcon} alt="tailwind" />
          <img className="w-32 flex" src={NextjsIcon} alt="nextjs" />
          <img className="w-32 flex" src={ReduxIcon} alt="redux" />
          <img className="w-32 flex" src={NodejsIcon} alt="nodejs" />
          <img className="w-32 flex" src={MongodbIcon} alt="mongodb" />
